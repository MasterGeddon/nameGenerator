...
String [] namen_a_m = {"Aaron","Abdul","Abel","Abraham","Achim","Adam","Adolf","Adreon","Adrian","Adriano","Adrien","Aeneas","Ahe","Aheahe","Aidan","Aiden","Aika", 

"Aimo","Akamai","Akamu","Akela","Aki","Akoni","Alain","Alan","Alarich","Albert","Albrecht","Alec","Alessandro" 

,"Alessio","Alex","Alexander","Alexej","Alexis","Alfons","Alfred","Ali","Alika","Aljoscha","Allard","Aloha","Alois","Alrik","Alvaro","Alwin", 

"Amadeus","Amandus","Amaranth","Amel","Amelio","Amir","Amiran","Amon","Anais","Anakin","Anders" 

,"Andre","André","Andrea","Andreas","Andrej","Andres","Andrew","Andrico","Andrik","Andy","Angus","Anian","Aniani","Anil","Annick","Anno","Ano", 

"Anouck","Anouk","Anselm","Ansgar","Anthony","Antoine","Anton","Antonie","Antonio","Antonios","Antonius","Aolani" 

,"Aoloa","Aouli","Aragorn","Aramis","Arendt","Ares","Ari","Arian","Ariel","Arik","Aris","Arlan","Arman","Armand","Armin","Arndt","Arne","Arnit", 

"Arno","Arnold","Aron","Arthur","Artur","Arved","Arvid","Arwed","Asger","Asmus","Athan","Attila","August" 
...
String[] konsonanten = {"b","c","d","f","g","h","j","k","l","m","n","p","q","r","s","t","v","w","x","z", 
...
/** gibt entweder einen Namen oder mehrere Namen aus und gibt die länge der namen an **/ 
...
/** gibt entweder einen Namen oder mehrere Namen aus und gibt sowohl die Länge als auch eine Namens liste an **/ 
...
/**  gibt die anzahl an namen aus mit bestimmeter namens länge und bestimmter Namensliste **/ 
 ...
 * generiert einen Namen anhand von einem array aus namen und dessen Namens länge 
...
private void ausgabe(String [] genNames) { 
...
fetz[i]=vokale[(int)(vokale.length*Math.random())]+konsonanten[(int)(konsonanten.length*Math.random())]; 
...
fetz[i]=konsonanten[(int)(konsonanten.length*Math.random())]+vokale[(int)(vokale.length*Math.random())]; 
...
fetz[i]=konsonanten[(int)(konsonanten.length*Math.random())]+vokale[(int)(vokale.length*Math.random())]+konsonanten[(int)(konsonanten.length*Math.random())]; 
...
fetz[i]=vokale[(int)(vokale.length*Math.random())]+konsonanten[(int)(konsonanten.length*Math.random())]+vokale[(int)(vokale.length*Math.random())]; 
...
fetz[i]=konsonanten[(int)(konsonanten.length*Math.random())]+vokale[(int)(vokale.length*Math.random())]+konsonanten[(int)(konsonanten.length*Math.random())]+konsonanten[(int)(konsonanten.length*Math.random())]; 
 ...
 * Dies funktion speichert sowohl die Wort Fetzen als auch deren Modus ab , um später möglicherweise diese zu größeren wörtern zusammen zu setzen 
...
fetz[i][1]=vokale[(int)(vokale.length*Math.random())]+konsonanten[(int)(konsonanten.length*Math.random())]; 
...
fetz[i][1]=konsonanten[(int)(konsonanten.length*Math.random())]+vokale[(int)(vokale.length*Math.random())]; 
...
fetz[i][1]=konsonanten[(int)(konsonanten.length*Math.random())]+vokale[(int)(vokale.length*Math.random())]+konsonanten[(int)(konsonanten.length*Math.random())]; 
...
fetz[i][1]=vokale[(int)(vokale.length*Math.random())]+konsonanten[(int)(konsonanten.length*Math.random())]+vokale[(int)(vokale.length*Math.random())]; 
...
fetz[i][1]=konsonanten[(int)(konsonanten.length*Math.random())]+vokale[(int)(vokale.length*Math.random())]+konsonanten[(int)(konsonanten.length*Math.random())]+konsonanten[(int)(konsonanten.length*Math.random())]; 
